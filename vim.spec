...
Conflicts: vim-filesystem < %{epoch}:%{version}-%{release}
Conflicts: vim-minimal < %{epoch}:%{version}-%{release}

%description data
The subpackage is used for shipping files and directories, which need to
be shared between vim-minimal and vim-common packages.

%package common
Summary: The common files needed by any version of the VIM editor
Requires: vim-data = %{epoch}:%{version}-%{release}
...
mkdir -p %{buildroot}/%{_datadir}/vim/vimfiles/{after,autoload,colors,compiler,doc,ftdetect,ftplugin,indent,keymap,lang,plugin,print,spell,syntax,tutor}
mkdir -p %{buildroot}/%{_datadir}/vim/vimfiles/after/{autoload,colors,compiler,doc,ftdetect,ftplugin,indent,keymap,lang,plugin,print,spell,syntax,tutor}
%make_install
...
%dir %{_datadir}/vim/vimfiles/colors
...
%dir %{_datadir}/vim/vimfiles/keymap
%dir %{_datadir}/vim/vimfiles/lang
%dir %{_datadir}/vim/vimfiles/plugin
%dir %{_datadir}/vim/vimfiles/print
%dir %{_datadir}/vim/vimfiles/spell
%dir %{_datadir}/vim/vimfiles/syntax
%dir %{_datadir}/vim/vimfiles/tutor
...
%files common
%exclude %{_datadir}/vim/vim82/defaults.vim
